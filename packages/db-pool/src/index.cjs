...
__export(exports_src, {
  requireLongLivedDeploymentProfile: () => requireLongLivedDeploymentProfile,
  getDeploymentProfile: () => getDeploymentProfile,
  getDatabaseUrl: () => getDatabaseUrl,
  createPooledSql: () => createPooledSql,
  createDirectSql: () => createDirectSql,
  __resetCachedDeploymentProfileForTests: () => __resetCachedDeploymentProfileForTests
});
...
function createDirectSql(extra = {}, dsn) {
  ...
  return src_default((dsn && dsn.trim()) || getDatabaseUrl(), {
    max: 40,
    idle_timeout: 20,
    connect_timeout: 10,
    ...extra
